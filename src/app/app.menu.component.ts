...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            {
                label: 'Collection', icon: 'pi pi-sliders-v',
                items: [
                    { label: 'Collection List', routerLink: ['/collection'] },
                    { label: 'Product List', routerLink: ['/collection/product'] },
                    { label: 'Varient List', routerLink: ['/collection/varient'] },
                    { label: 'Item List', routerLink: ['/collection/item'] },
                ]
            },
            {
